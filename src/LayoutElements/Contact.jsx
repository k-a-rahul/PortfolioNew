...
function Contact() {
  ...
  return (
    <>
      <div className="h-screen w-screen flex flex-col justify-evenly items-center sm:p-10">
      <div className="w-[95%] sm:w-[50%] flex gap-2 flex-col justify-evenly overflow-hidden items-center text-center" >
      <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26987.944308327926!2d75.64086889918016!3d32.27171982675917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391c7f5d473c84b3%3A0x5335739bee705d89!2sPathankot%2C%20Punjab%20145001!5e0!3m2!1sen!2sin!4v1726067323337!5m2!1sen!2sin"  allowFullScreen loading="lazy" width={w} height={h}  ></iframe>
      <Form />
      </div>
