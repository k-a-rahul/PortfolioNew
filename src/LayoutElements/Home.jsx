  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex flex-col animate-bounce justify-center absolute ${display} transition-all w-40 text-sm sm:w-52 sm:text-xl text-white rounded-2xl bg-bg-blue`}
        >
        ...
        >
          ...
          >
            <span>
              ...
              <p className="p-2 text-sm md:text-base lg:text-lg text-black tracking-tight lg:tracking-normal">
